...
GET_FullVersion=$(cat /tmp/Github_Tags | egrep -o "AutoBuild-$CURRENT_DEVICE-Master.[0-9]+" | awk 'END {print}')
GET_Version="${GET_FullVersion#*Life-}"
...
Firmware_Info="$GET_FullVersion-efi"
fi
