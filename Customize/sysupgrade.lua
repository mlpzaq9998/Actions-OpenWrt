...
function to_check(model)
	...
	if model == "x86_64" then
		api.exec(api.wget, {api._unpack(api.wget_args), "-O", version_file, "https://github.com/mlpzaq9998/Actions-OpenWrt/releases/download/AutoUpdate/AutoBuild-x86_64-OpenWrt-Life-Version.txt"}, nil, api.command_timeout)
